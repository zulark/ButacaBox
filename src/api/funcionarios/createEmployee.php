...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($data['nome'], $data['email'], $data['senha'], $data['filial_id'], $data['salario_base'])) {
    ...
    $sql = "INSERT INTO funcionarios (nome, email, senha, filial_id, salario_base) 
            VALUES ('$nome', '$email', '$senhaCriptografada', '$filial_id', '$salario_base')";
